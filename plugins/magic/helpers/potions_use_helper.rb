...
#  Is ANY of this used anymore?
    ...
    #   Rooms.emit_to_room(caster.room, t('magic.casts_noncombat_spell', :name => caster.name, :potion => spell))
    ...
    #     FS3Combat.emit_to_combat caster.combat, t('magic.potion_heal', :name => caster.name, :potion => spell, :target => "themself", :points => heal_points)
    #   else
    #     FS3Combat.emit_to_combat caster.combat, t('magic.potion_heal_no_effect', :name => caster.name, :potion => spell, :target => "themself")
    #   end
    # end
    ...
    #   if (wound)
    #     FS3Combat.heal(wound, heal_points)
    #     client.emit t('magic.potion_heal', :name => caster.name, :potion => spell,  :target => "themself", :points => heal_points)
    #   else
    #     client.emit t('magic.potion_heal_no_effect', :name => caster.name, :potion => spell, :target => "themself")
    #   end
    # end
    ...
    #   FS3Combat.emit_to_combat caster_combat.combat, t('magic.potion_stance', :name => caster_combat.name, :target => "themself", :potion => spell, :stance => stance)
    # end
