module AresMUSH
  module Swrifts
	...
	def self.returniconicforcg(char, swrifts_race, rawcharrace, model)
		...
		iconicfarray << {name: 'None ~ Select to reset Iconic Framework', disabled: false, desc: 'Choose to reset Iconic Framework'}
		return (iconicfarray)
	end	
	...
	def self.returnraceforcg(char, swrifts_race, ifname, model)
		...
		racearray << {name: 'None ~ Select to reset Race', disabled: false, desc: 'Choose to reset Race', class: 'none'}
		return (racearray)
	end
