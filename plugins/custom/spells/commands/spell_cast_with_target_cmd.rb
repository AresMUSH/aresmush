  ...
  module Custom
    class SpellCastWithTargetCmd
      ...
      def check_errors
        ...
        return t('custom.already_cast') if Custom.already_cast(self.caster_combat)
      ...
      def handle
        cast = Custom.already_cast(self.caster_combat)
        client.emit cast
        ...
        #Reading Config Files
          ...
          if is_revive
            if (!self.target.is_ko)
              ...
              Custom.cast_revive(self.caster, self.target_combat, self.spell)
            end
          end
          ...
          #Change stance
          if stance
            Custom.cast_stance(self.caster, self.target_combat, self.spell)
          end
