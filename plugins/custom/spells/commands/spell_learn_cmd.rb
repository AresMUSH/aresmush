  ...
  module Custom
    class SpellLearnCmd
      ...
      def check_errors
        ...
        return t('custom.request_spell') if (self.spell == "Natural Weaponry" || self.spell == "Natural Defense" || self.spell == "Wild Shape" || self.spell == "Greater Wild Shape" || self.spell == "Half Shift")
