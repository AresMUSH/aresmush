module AresMUSH
  module Custom
    class SpellLearnCmd
      ...
      attr_accessor :spell, :spell_list, :school
      ...
      def handle
        ...
        spell_level = Global.read_config("spells", self.spell, "level")
        if spell_learned
          if spell_learned.learning_complete
            ...
            if xp_needed < 1
              ...
              message = t('custom.xp_learned_spell', :name => enactor.name, :spell => self.spell, :level => spell_level, :school => self.school)
          ...
          SpellsLearned.create(name: self.spell, last_learned: Time.now, level: spell_level, character: enactor, xp_needed: xp_needed, learning_complete: false)
