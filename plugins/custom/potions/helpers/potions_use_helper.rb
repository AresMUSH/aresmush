module AresMUSH
  module Custom
    ...
    def self.potion_equip_armor(enactor, caster_combat, spell)
      ...
      FS3Combat.emit_to_combat caster_combat.combat, t('custom.use_potion', :name => caster_combat.name, :spell => spell)
    ...
    def self.potion_heal(caster_combat, caster, spell)
      ...
      if (wound)
        ...
        FS3Combat.emit_to_combat caster.combat, t('custom.potion_heal', :name => caster.name, :spell => spell, :target => "themself", :points => heal_points)
      else
        FS3Combat.emit_to_combat caster.combat, t('custom.potion_heal_no_effect', :name => caster.name, :spell => spell, :target => "themself")
      end
    end
    ...
    def self.potion_non_combat_heal(caster, spell)
      ...
      if (wound)
        FS3Combat.heal(wound, heal_points)
        client.emit t('custom.potion_heal', :name => caster.name, :spell => spell,  :target => "themself", :points => heal_points)
      else
        client.emit t('custom.potion_heal_no_effect', :name => caster.name, :spell => spell, :target => "themself")
      end
    end
    ...
    def self.potion_stance(caster_combat, spell)
      ...
      FS3Combat.emit_to_combat caster_combat.combat, t('custom.potion_stance', :name => caster_combat.name, :target => "themself", :spell => spell, :stance => stance)
    end
    ...
    def self.potion_lethal_mod(caster_combat, spell)
      ...
      FS3Combat.emit_to_combat caster_combat.combat, t('potion_mod', :name => caster_combat.name, :spell => spell, :target => "themself", :mod => lethal_mod, :type => "lethality", :total_mod => caster_combat.damage_lethality_mod)
    end
    ...
    def self.potion_defense_mod(caster_combat, spell)
      ...
      FS3Combat.emit_to_combat caster_combat.combat, t('custom.potion_mod', :name => caster_combat.name, :target => "themself", :spell => spell, :mod => defense_mod, :type => "defense", :total_mod => caster_combat.defense_mod)
    end
    ...
    def self.potion_spell_mod(caster_combat, spell)
      ...
      FS3Combat.emit_to_combat caster_combat.combat, t('custom.potion_mod', :name => caster_combat.name, :target => "themself", :spell => spell, :mod => spell_mod, :type => "spell", :total_mod => caster_combat.spell_mod)
    end
    ...
    def self.potion_attack_mod(caster_combat, spell)
      ...
      FS3Combat.emit_to_combat caster_combat.combat, t('custom.potion_mod', :name => caster_combat.name, :target => "themself", :spell => spell, :mod => attack_mod, :type => "attack", :total_mod => caster_combat.attack_mod)
    end
