    ...
    describe FS3Combat do
      ...
      describe :worst_treatable_wound do
        before do
          ...
          allow(@damage4).to receive(:current_severity) { "MODERATE" }
          ...
          allow(@damage4).to receive(:is_treatable?) { true }
        end

        it "should return the most serious wound if all treatable" do
          allow(@char).to receive(:damage) { [@damage1, @damage2, @damage3, @damage4] }
        ...
        it "should return nil if no treatable wounds" do
          ...
          allow(@damage4).to receive(:is_treatable?) { false }
          allow(@char).to receive(:damage) { [@damage1, @damage2, @damage3, @damage4] }
