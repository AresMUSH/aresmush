  ...
  module FS3Combat
    class EscapeAction < CombatAction
      ...
      def reset_subdue
        ...
        self.combatant.update(magic_stun: false)
        self.combatant.update(magic_stun_counter: 0)
      ...
      def resolve
        ...
        elsif combatant.magic_stun
          margin = FS3Combat.determine_magic_stun_escape_margin(self.subduer, self.combatant)
          if margin[:hit]
