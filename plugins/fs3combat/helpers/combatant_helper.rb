module AresMUSH
  module FS3Combat
    ...
    def self.roll_initiative(combatant, ability)
      ...
      combatant.log "Initiative roll for #{combatant.name} ability=#{ability} action=#{action_mod} weapon=#{weapon_mod} luck=#{luck_mod} spell=#{init_spell_mod} gm=#{gm_mod} roll=#{roll}"
