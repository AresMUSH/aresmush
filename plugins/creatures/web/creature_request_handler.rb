    ...
    class CreatureRequestHandler
      def handle(request)
...

        {
          ...
          edit_speed: Website.format_input_for_html(creature.speed),
          speed: Website.format_markdown_for_html(creature.speed),
          edit_length: Website.format_input_for_html(creature.length),
          length: Website.format_markdown_for_html(creature.length),
          edit_height: Website.format_input_for_html(creature.height),
          height: Website.format_markdown_for_html(creature.height),
