  ...
  module Profile
    class ProfileEditRequestHandler
      def handle(request)
        ...
        add_to_profile profile_data, Login.build_web_profile_edit_data(char, enactor, profile_manager)
        add_to_profile profile_data, Status.build_web_profile_edit_data(char, enactor, profile_manager)
