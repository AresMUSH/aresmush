module AresMUSH
  class WebApp
    ...
    post '/admin/fs3_skills/update', :auth => :admin do
      ...
      output_path = File.join(AresMUSH.game_path, 'config', 'fs3skills_action.yml')
      ...
      output_path = File.join(AresMUSH.game_path, 'config', 'fs3skills_attrs.yml')
      write_config_file output_path, config.to_yaml
      ...
      output_path = File.join(AresMUSH.game_path, 'config', 'fs3skills_langs.yml')
      write_config_file output_path, config.to_yaml
