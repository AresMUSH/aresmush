module AresMUSH
  module FS3Skills
    ...
    def self.attr_review(points)
      max = Global.read_config("fs3skills", "max_points_in_attributes")
    ...
    def self.action_skill_review(points)
      max = Global.read_config("fs3skills", "max_points_in_action_skills")
      error = points > max ? t('chargen.too_many') : t('chargen.ok')
    ...
    def self.bg_skill_review(char)
      ...
      min = Global.read_config("fs3skills", "min_background_skills")
