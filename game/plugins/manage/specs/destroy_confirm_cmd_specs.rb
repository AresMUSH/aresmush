        ...
        context "success" do
          ...
          context "destroying a room" do
            ...
            it "should tell an online char they're being moved and move them" do
              ...
              Rooms::Interface.should_receive(:send_to_welcome_room).with(client_in_room, @char_in_room)
              handler.handle
            end
          
            it "should move them to the welcome room" do
              @char_in_room.stub(:client) { nil }
              Rooms::Interface.should_receive(:send_to_welcome_room).with(nil, @char_in_room)
              handler.handle
            end
          end
        end
