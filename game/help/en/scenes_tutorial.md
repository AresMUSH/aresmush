...
* **Traditional**: Live, synchronous RP with poses coming ~5-15 minutes apart. (Default Setting)
* **Distracted**: RP that is still synchronous, but with longer time between poses due to work or other distractions. May include long pauses, communicated clearly to players. Generally completed within 24 hours of start.
* **Asynchronous**: RP with poses coming in at various times, possibly in different timezones or schedules, or even over multiple days. Generally completed 48 hours - 1 week of start.
